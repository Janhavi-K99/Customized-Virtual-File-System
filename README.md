...
*(Add a GIF or video link here showing the GUI in action — creating files, watching bitmaps update, running CLI commands)*

---

## Screenshots

*(Add screenshots here — main window, file explorer panel, visualization panel, CLI shell)*
